<template>
  <div id="app">
    ...
    <MyOrdersView v-else-if="currentView === 'orders'" @navegar="cambiarVista" />
  </div>
</template>
...
// Función para cambiar de vista (la reciben los hijos)
const cambiarVista = (vistaDestino) => {
  currentView.value = vistaDestino;
};
</script>
